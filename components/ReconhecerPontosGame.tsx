...
const GAME_ID = 'reconhecer-pontos';
const MIN_COORD = -4;
const MAX_COORD = 4;
...
interface ReconhecerPontosGameProps {
  onReturnToMenu: () => void;
  onAdvance?: () => void;
...
export const ReconhecerPontosGame: React.FC<ReconhecerPontosGameProps> = ({ onReturnToMenu, onAdvance, advanceButtonText }) => {
  ...
  const initializeGame = useCallback(() => {
    ...
    setComboCount(0);
    resetChallengeState();
    setUserMessage('Digite as coordenadas do ponto amarelo.');
    setMessageType('info');
      ...
      <div className="relative bg-slate-800 shadow-2xl rounded-xl p-6 md:p-8 w-full max-w-2xl">
        ...
        {gameOver ? (
          ...
          <>
            ...
            <CoordinateInput onSubmit={handleGuessSubmit} disabled={!isChallengeActive}/>
